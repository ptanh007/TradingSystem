        ...
        html.Div(  
            [
                ...
                dcc.Dropdown(
                    ...
                    style = dict(width = '150px', display = 'inline-block', verticalAlign = "middle"
                    )
                )
            ]   
        ),   
...
def update_info(button_disabled, ticker, start_date, end_date, interval):
...
def run_macrossover(n_clicks, ticker, start_date, end_date, interval):
    report_dict = {}
    if n_clicks:
        report_dict = strat_macrossover.run_strat(ticker, start_date, end_date, interval)
